...
import { ArrowLeft, Copy, ThumbsUp, Bookmark, Share2 } from "lucide-react"
                            ...
                            <Card>
                                <CardContent className="p-6">
                                    ...
                                    <div className="grid grid-cols-2 gap-4">
                                        ...
                                        <Button
                                            variant={internalSave ? "default" : "outline"}
                                            className="w-full"
                                            onClick={() => toggleSave()}
                                        >
                                        ...
                                        <Button variant="outline" className="w-full col-span-2" onClick={() => share()}>
